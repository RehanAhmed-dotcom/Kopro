...
const Creatgroupscreen = ({navigation, route}) => {
  ...
  //   console.log('group all members', groupAllMembers);
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.bottomcontainer}>
          <ButtonComp
            onPress={() => {
              groupInfo ? updateGroup() : createGroup();
            }}
